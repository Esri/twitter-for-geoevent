...
public class TwitterInboundTransportService extends TransportServiceBase
{
  public TwitterInboundTransportService()
  {
    super();
    definition = new XmlTransportDefinition(getResourceAsStream("twitter-inboundtransport-definition.xml"));
  }
